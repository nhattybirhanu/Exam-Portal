...
//getUser, userSignup, userLogin, deleteUserById
   ...
   const user = await Users.findOne(filed==='username'?{username:value}:{email:value}).select(['username']);
   return res.send(user===null)
  
}
module.exports={userLogin,userSignup,listAllUsers,getUser,checkFiledAvailale}